...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 30, 2019 lúc 05:58 AM
...
(43, 'Fender CN-60S ', 5, 5360000, 'Fender', 'Classic', 'Fender CN-60S Classical Natural giúp người trải nghiệm sự thuận tiện của dây Nylon và âm thanh của dây thép', 0),
...
(53, 'Fender Player Strat MN', 6, 18070000, 'Fender', 'Stratocaster®', 'Fender Player Strat MN được thiết kế theo phong cách Stratocaster với cần đàn bằng gỗ maple cùng những tính năng hiện đại mang đến âm thanh đẳng cấp cho người dùng', 1),
...
(7, 'tutututu@gmail.com', 'c4ca4238a0b923820dcc509a6f75849b', 'tutututu', NULL, NULL),
